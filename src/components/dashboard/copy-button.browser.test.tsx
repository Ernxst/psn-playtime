...
test("writes the value to the clipboard and fires onCopy once when clicked", async () => {
  const onCopy = vi.fn();
...
test("confirms the copy by swapping the label to Copied", async () => {
...
test("renders an icon-only control labelled by its accessible name", async () => {
